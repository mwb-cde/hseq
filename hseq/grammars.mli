...
sig
  ...
  val (?%): Lexer.tok -> Gtype.t phrase
(** [?% sym]: Utility function for building type parsers using
    {!Parserkit.T.seq}. Parse symbol [sym], return term [Gtype.mk_var
...
val mk_type_binary_constr:
  parser_info -> Lexer.tok -> Gtype.t -> Gtype.t -> Gtype.t
...
val mk_type_unary_constr:
  parser_info -> Lexer.tok -> Gtype.t -> Gtype.t
...
val primed_id: parser_info -> Gtype.t phrase
(** [primed_id inf]: Read a type variable name. *)

val bool_type: parser_info -> Gtype.t phrase
(** [bool_type info]: Parse type "bool" *)
val num_type: parser_info -> Gtype.t phrase
(** [num_type info]: Parse type "num" *)

val type_constructor_parser: parser_info -> Gtype.t phrase
(** [type_constructor_parser inf]: Parse "['(' <args> ')']<constructor>" *)

val bracketed_type_parser: parser_info -> Gtype.t phrase
(** [bracketed_type_parser info]: Parse "'(' <type> ')'" *)


val inner_types: parser_info -> Gtype.t Pkit.phrase
(** Parse infix/prefix/suffix type operators *)

val atomic_types: parser_info -> Gtype.t phrase
...
val type_parsers: parser_info -> Gtype.t phrase
(** The parser made from {!Grammars.inner_types}) *)

val types: parser_info -> Gtype.t phrase
...
val optional_type : parser_info -> Gtype.t option phrase
...
val defn:
  parser_info ->
  (((string * Gtype.t) * Pterm.t list) * Pterm.t) phrase
