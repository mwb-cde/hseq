...
let test_basics() =
  ...
  let a = Basic.mk_gtype_id "a"
  and a_1 = Basic.mk_gtype_id "a"
  and b = Basic.mk_gtype_id "b"
  and b_1 = Basic.mk_gtype_id "b"
  and aa = Basic.mk_gtype_id "aa"
  and ab = Basic.mk_gtype_id "ab"
  and bb = Basic.mk_gtype_id "bb"
  and ba = Basic.mk_gtype_id "ba"
  in
  EXPECT_TRUE(Basic.gtype_id_equal a a);
  EXPECT_TRUE(Basic.gtype_id_equal a_1 a_1);
  EXPECT_FALSE(Basic.gtype_id_equal a a_1);
  EXPECT_FALSE(Basic.gtype_id_equal a_1 a);

  EXPECT_TRUE(Basic.gtype_id_equal b b);
  EXPECT_TRUE(Basic.gtype_id_equal b_1 b_1);
  EXPECT_FALSE(Basic.gtype_id_equal b a);
  EXPECT_FALSE(Basic.gtype_id_equal b b_1);

  EXPECT_EQL(Basic.gtype_id_compare a a, Order.Equal);
  EXPECT_EQL(Basic.gtype_id_compare a_1 a_1, Order.Equal);
  EXPECT_NEQ(Basic.gtype_id_compare a a_1, Order.Equal);
  EXPECT_NEQ(Basic.gtype_id_compare a_1 a, Order.Equal);

  EXPECT_EQL(Basic.gtype_id_compare a aa, Order.LessThan);
  EXPECT_EQL(Basic.gtype_id_compare aa ab, Order.LessThan);
  EXPECT_EQL(Basic.gtype_id_compare aa ba, Order.LessThan);
  EXPECT_EQL(Basic.gtype_id_compare ba bb, Order.LessThan);

  EXPECT_EQL(Basic.gtype_id_compare aa a, Order.GreaterThan);
  EXPECT_EQL(Basic.gtype_id_compare b aa, Order.GreaterThan);
