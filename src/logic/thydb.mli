...
val get_importing : thydb -> string list
...
(**
   [get_id_options n db]:
   Get list of term identifiers and their types with the name [n].
   The list is in the order of appearence in the importing list.
*)
...
*)
(*
   [thy_in_scope thy db]: test that theory [thy] is in importing list
 *)
