...
type t=
    { 
      ...
      term_type : Hident.t -> gtype; 
      (** The type of a term identifier. *)
      term_thy : string -> Hident.thy_id;
      (** The theory in which a term is declared. *)
      type_defn: Hident.t -> type_record;
      (** The definition (if any) of a type. *)
      type_thy : string -> Hident.thy_id;
      (** The theory in which a type is declared. *)
      thy_in_scope : Hident.thy_id -> bool ;
...
val thy_of : t -> Hident.thy_id
(** [thy_of scp]: Get the theory name of scope [scp]. *)

val type_of : t -> Hident.t -> gtype
(** Lookup the type of an identifier. *)

val thy_of_term: t -> string -> Hident.thy_id
(** Lookup the theory of an identifier. *)

val defn_of: t -> Hident.t -> type_record
(** Get the definition of a type. *)

val thy_of_type: t -> string -> Hident.thy_id
(** Lookup the theory of a type. *)

val in_scope : t -> Hident.thy_id -> bool
