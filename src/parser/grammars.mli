...
(** Parser constructors for types and terms 
   ...
   described as a {!Grammars.phrase}, and a phrase can also be
...
(** {7 Parser Grammars} *)
	...
	(**
	    [repeat_term ph1 ph2]: Repeatedly parse phrase [ph1],
	    terminated by final phrase [ph2]
	*)
      ...
      val id_relaxed: infotyp -> Ident.t phrase
	  (**
	     [id_relaxed info inp]: Relaxed identifier parser.
	     Matches (possibly qualified) identifiers and symbols.
	   *)   
	...
	(**
	   [mk_type_binary_constr inf tok l r]:
	   Make a gtype from binary type from
	   constructor [tok], left argument [l]
	   and right argument [r].
	*)
	...
	*)
	  ...
	  (**
	     ...
	     {!Grammars.inner_types}.  Can be extended with
...
(** {7 Support for adding parsers} 
   ...
   {!Grammars.type_parsers_list} used by
   {!Grammars.types}.
